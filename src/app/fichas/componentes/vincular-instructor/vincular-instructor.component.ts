...
@Component({
  selector: 'app-vincular-instructor',
  templateUrl: './vincular-instructor.component.html',
  styleUrls: ['./vincular-instructor.component.css']
})
export class VincularInstructorComponent {
